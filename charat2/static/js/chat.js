...
function getTimestamp(seconds_from_epoch) {
    ...
    return (month_names[timestamp.getMonth()]<10?'0':'')+month_names[timestamp.getMonth()]+' '+timestamp.getDate()+' '+timestamp.getHours()+':'+(timestamp.getMinutes()<10?'0':'')+timestamp.getMinutes();
}
