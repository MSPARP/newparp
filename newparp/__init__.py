...
app.add_url_rule("/reset_password", "account_reset_password", account.reset_password_get, methods=("GET",))
app.add_url_rule("/reset_password", "account_reset_password_post", account.reset_password_post, methods=("POST",))
app.add_url_rule("/forgot_password", "account_forgot_password", account.forgot_password_get, methods=("GET",))
app.add_url_rule("/forgot_password", "account_forgot_password_post", account.forgot_password_post, methods=("POST",))
